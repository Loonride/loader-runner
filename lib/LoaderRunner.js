...
function iteratePitchingLoaders(options, loaderContext, callback) {
	...
	if(loaderContext.loaderIndex >= loaderContext.loaders.length || stopped)
...
function iterateNormalLoaders(options, loaderContext, args, callback) {
	if(loaderContext.loaderIndex < 0 || stopped)
...
exports.endLoadersEarly = function endLoadersEarly() {
	stopped = true;
};
